...
int main(int argc, char *argv[])
{
   ...
   if (argc > 1)
   {
        ...
        AKDController::ecat_pdoEntry_t tx[1] = {{0x6041,0}};
        AKDController::ecat_pdoEntry_t rx[4] = {{0x6040,0},{0x6072,0},{0x607A,0},{0x6081,0}};
        ...
        master1.confSlavePDOs(1, &s1, sizeof(s1), 0x1600, 0x1601,0,0, 0x1a00, 0,0,0);
        master1.confSlavePDOs(2, &s2, sizeof(s2), 0x1600, 0x1601,0,0, 0x1a00, 0,0,0);
